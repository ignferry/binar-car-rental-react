    ...
    return (
        <>
            <div className="d-flex justify-content-between mb-3">
                <h1>Cars</h1>
                <Button onClick={() => navigate("/dashboard/cars/create")}>Add Cars</Button>
            </div>
            

            <div className="d-flex mb-3">
                <Button className="me-2" onClick={() => loadCars("")}>All</Button>
                <Button className="me-2" onClick={() => loadCars("small")}>Small</Button>
                <Button className="me-2" onClick={() => loadCars("medium")}>Medium</Button>
                <Button className="me-2" onClick={() => loadCars("large")}>Large</Button>
            </div>
