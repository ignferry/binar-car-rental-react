...
export default function Search() {
  ...
  async function submitSearch(e: React.FormEvent<HTMLFormElement>) {
    ...
    const dateTime = createDateString(
      target.elements.tanggal.value as string,
      target.elements.waktu.value as string,
    );
        ...
        <form className="w-100" id="search-form" onSubmit={submitSearch}>
          <div className="row p-3 shadow rounded search-form-div">
            <div className="search-input-div form-group">
              <label htmlFor="input-tipe-driver" className="form-label">
                Tipe Driver
              </label>
              <select
                className="form-select"
                id="input-tipe-driver"
                name="driver"
                defaultValue={''}
              >
                <option value="" hidden>
            ...
            <div className="search-input-div form-group">
              <label htmlFor="input-tanggal" className="form-label">
                Tanggal
              </label>
              <input
                type="date"
            ...
            <div className="search-input-div form-group">
              <label htmlFor="input-waktu" className="form-label">
                Waktu Jemput/Ambil
              </label>
              <select
                className="form-select"
            ...
            <div className="search-input-div form-group">
              <label htmlFor="input-penumpang" className="form-label">
