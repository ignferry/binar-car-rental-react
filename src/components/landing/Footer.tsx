    ...
    <footer className="container-fluid col-md-10 mb-2 mb-md-5">
      <div className="row row-cols-1 row-cols-md-4">
        ...
        <div className="col col-md-2 mb-3 d-flex flex-column fw-bold">
          <a className="my-2" href="#ourServices">
            Our Services
          </a>
          <a className="my-2" href="#whyUs">
            Why Us
          </a>
        ...
        <div className="col col-md-3 mb-3 d-flex flex-column">
          ...
          <div className="my-2">
            <a href="https://www.facebook.com/" target="_blank">
              <img src={IconFacebook} className="me-2 mb-2" />
            </a>
            <a href="https://www.instagram.com/" target="_blank">
              <img src={IconInstagram} className="me-2 mb-2" />
            </a>
            <a href="https://www.twitter.com/" target="_blank">
              <img src={IconTwitter} className="me-2 mb-2" />
            </a>
            <a href="mailto: binarcarrental@gmail.com" target="_blank">
              <img src={IconMail} className="me-2 mb-2" />
            </a>
            <a href="https://www.twitch.com/" target="_blank">
              <img src={IconTwitch} className="me-2 mb-2" />
            </a>
          </div>
        </div>
        <div className="col col-md-3 mb-3 d-flex flex-column">
