    ...
    <header className="fixed-top">
      <nav className=" bg-blue navbar navbar-expand-md justify-content-center">
        <div className="col-md-10 container-fluid">
          ...
          <button
            className="d-md-none offcanvas-button"
            type="button"
          ...
          <div
            id="sideNavBar"
            className="offcanvas-md offcanvas-end d-block d-md-none w-50 py-3"
            tabIndex={-1}
          >
            ...
            <div className="offcanvas-body">
              <ul>
                <li>
                  <a href="#ourServices" className="offcanvas-link">
                    Our Services
                  </a>
                </li>
                <li>
                  <a href="#whyUs" className="offcanvas-link">
                    Why Us
                  </a>
                </li>
                <li>
                  <a href="#testimonial" className="offcanvas-link">
                    Testimonial
                  </a>
                </li>
                <li>
                  <a href="#faq" className="offcanvas-link">
                    FAQ
                  </a>
                </li>
              </ul>
